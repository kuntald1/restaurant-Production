...
class UserRoleMapping(Base):
    ...
    userrolemapping_id = Column("userrolemappingid", BigInteger,  primary_key=True, index=True, autoincrement=True)
    userrole_id        = Column("userroleid",        BigInteger,  nullable=False)
    menu_id            = Column("menuid",            BigInteger,  nullable=False)
